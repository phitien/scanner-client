...
export default class CorePage extends CoreComponent {
    get containerClassName() {return this.props.containerClassName !== undefined ? this.props.containerClassName : ''}
    ...
    get content() {return this.showLogin ? <CoreLogin/> : this.props.renderer.content}
    get sidebar() {
